...
import { UserRegister } from "../store/Slices/UserRegister/UserRegisterFunction";  // Correct import
...
const RegisterScreen = () => {
  ...
  const submitHandler = async (e) => {
    ...
    if (password !== confirmPassword) {
      ...
      // Приведення isProfessional до числового значення
      const isProfInt = isProfessional ? 1 : 0;
      UserRegister(dispatch, name, email, password, isProfInt);
      navigate("/login");
    }
};
  ...
  return (
    <div className="page-screen row d-flex justify-content-center align-items-center h-100">
      <Row className="shadow-lg p-3">
        <h1 className="center-text">For Professionals</h1>
        <Col md className="d-flex flex-column">
          ...
          <div className="d-flex justify-content-center" style={{ marginTop: '1rem' }}>
            <h6>
              At HydroPeptide, customers come first. We are committed to providing you with the best possible experience. We are open Monday through Friday, from 10:00 to 19:00 PT. If you have any questions or concerns, please email us at any time. We will make every effort to respond to you within 24 hours.
            </h6>
          </div>
          <li className="mb1">
            <a href="">
        ...
        <Col md>
          <div className="d-flex justify-content-center align-items-center flex-column">
            ...
            >
              ...
              <Form.Group controlId="isProfessional">
  <Form.Check
    type="checkbox"
    label="Are you a professional?"
    checked={isProfessional}
    onChange={(e) => setIsProfessional(e.target.checked ? 1 : 0)} // Змінено логіку встановлення значення
  />
</Form.Group>
