  ...
  return (
    <div className="page-screen row d-flex justify-content-center align-items-center height-100">
      <Row className="shadow-lg p-3">
        <Col md className="d-flex justify-content-center bg-white rounded text-center" style={{ marginTop: '200px' }}>
          <img src= "src/assets/h1.jpg" className="img-fluid" style={{ width: 'auto', height: '150px' }}/>
