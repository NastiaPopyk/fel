...
const ProductEditScreen = () => {
  ...
  const GetProdcut = async () => {
    ...
    await getProduct(id).then((response) => {
      ...
      setIsProfesional(response.data.isProfesional);
    });
    setTimeout(() => {
          ...
          <Card className="p-5 my-3">
            ...
            <Row className="my-4">
              ...
              <Row className="my-4">
                ...
                <Row className="my-2">
                  <Col md>
                    <Form.Label>Is Professional</Form.Label>
                    <Form.Control
                      as="select"
                      className="my-2 rounded"
                      value={isProfesional ? "true" : "false"}
                      onChange={(e) => setIsProfesional(e.target.value === "true")}
                    >
